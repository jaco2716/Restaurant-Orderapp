...
//SALATER
    [
      MenuItem(6, 'INSALATA CAPRESE Test', 'Med frisk mozzarella, frisk basilikum, stilk tomat og hjemmelavet pesto', 89, 'assets/orderapptest/menu/1.jpg', 0,
          meatChoice: []),
      MenuItem(7, 'KYLLING & BACON Test', 'Serveres med tomat, agurk, løg, peberfrugt, semi-dried tomater, salatmix og pesto', 89, '', 0, meatChoice: []),
      MenuItem(8, 'HJEMMELAVET TUNCREME Test', 'Serveres med tomat, agurk, løg, peberfrugt, semi-dried tomater, salatmix og pesto', 89,
          ...
          meatChoice: []),
      MenuItem(9, 'KYLLING PASTA SALAT Test', 'Serveres med penne, peberfrugt, semi-dried tomater, rucola, oliven og pesto', 89, '', 0, meatChoice: []),
    ],
...
//OMELETTER
    [
      ...
      MenuItem(12, 'HUSETS OMELET Test', 'Med løg, bacon, cherry tomater, olivenolie og cheddarost', 85, 'assets/orderapptest/menu/1.jpg', 0, meatChoice: []),
    ],
...
//PASTA RETTER
    [
      ...
      MenuItem(16, 'PASTA PESTO Test', 'Penne med kylling, hjemmelavet pesto og frisk grana', 89, 'assets/orderapptest/menu/1.jpg', 0, meatChoice: []),
    ...
    //ALLA CARTE
    [
      MenuItem(22, 'BØF CLASSICA Test', 'Mør og saftig oksefilet med bearnaisesauce og italiensk rosmarin kartofler', 159, '', 0, meatChoice: []),
      MenuItem(23, 'HVIDLØGS BØF Test', 'Mør og lækker oksefilet marineret med hvidløg, creme fraiche og kartofler', 159, '', 0, meatChoice: []),
      MenuItem(24, 'HUSETS BØF Test', 'Mør og saftig oksefilet med hjemmelavet whisky sauce og italienske rosmarin kartofler', 169, '', 0, meatChoice: []),
      MenuItem(25, 'TARTUFO Test', 'Mør og saftig oksefilet med hjemmelavet trøffel sauce og italienske rosmarin kartofler', 169, '', 0, meatChoice: []),
    ],
    ...
    [
      ...
      MenuItem(43, 'PATATA Test', 'Med kartofler, frisk mozzarella, frisk rosmarin og oliven', 89, 'assets/orderapptest/menu/1.jpg', 0, meatChoice: []),
      MenuItem(44, 'CONTADINA Test', 'Med frisk mozzarella, kylling, stegt bacon og spinat', 89, '', 0, meatChoice: []),
      MenuItem(45, 'MONDENA Test', 'Med frisk mozzarella, rucola, cherry tomater og frisk grana', 89, 'assets/orderapptest/menu/1.jpg', 0, meatChoice: []),
      MenuItem(46, 'HUSETS SPECIAL Test', 'Med italiensk bøfstrimler, løg, peberfrugt, champignon og sød sennep', 89, '', 0, meatChoice: []),
      MenuItem(47, 'SICILIA Test', 'Med frisk avokado, luksus bacon og cherry tomater m/u pesto', 89, 'assets/orderapptest/menu/1.jpg', 0, meatChoice: []),
