...
class CalculateValues {
  ...
  // static Future<bool> checkIfWithinOpenHours(DateTime currentDate) async {
  ...
  //                 currentTimeDouble > mondayCloseTime)) ||
  //         (currentDate.weekday == DateTime.tuesday &&
  //             (currentTimeDouble < tuesdayOpenTime ||
  //                 currentTimeDouble > tuesdayCloseTime)) ||
  //         (currentDate.weekday == DateTime.wednesday &&
  //             (currentTimeDouble < wednesdayOpenTime ||
  //                 currentTimeDouble > wednesdayCloseTime)) ||
  //         (currentDate.weekday == DateTime.thursday &&
  //             (currentTimeDouble < thursdayOpenTime ||
  //                 currentTimeDouble > thursdayCloseTime)) ||
  //         (currentDate.weekday == DateTime.friday &&
  //             (currentTimeDouble < fridayOpenTime ||
  //                 currentTimeDouble > fridayCloseTime)) ||
  //         (currentDate.weekday == DateTime.saturday &&
  //             (currentTimeDouble < saturdayOpenTime ||
  //                 currentTimeDouble > saturdayCloseTime)) ||
  //         (currentDate.weekday == DateTime.sunday &&
  //             (currentTimeDouble < sundayOpenTime ||
  //                 currentTimeDouble > sundayCloseTime))) {
