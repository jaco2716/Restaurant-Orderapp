...
class ReceiptListRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String orderDateString = _calculateValues.dateStringFromMili(order.orderDate);
    Icon orderIcon = Icon(
      Icons.watch_later,
      size: 35,
      color: Colors.orange,
    ...
    return Card(
      ...
      child: InkWell(
        ...
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => SingleReceiptPage(order, orderDateString, false)));
        },
      ),
    );
  }
